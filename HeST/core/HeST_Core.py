...
class CPD_Signal:
    def __init__(self, area_eV, chArea_eV, coincidence, arrivalTimes_us=[[]], bounced_flag = 0, num_bounces = 0, positions = 0, flavor = 'not_touched', momentums = 0, arrivals_unsorted= 0):
        ...
        self.arrivals_unsorted =  arrivals_unsorted
