...
./optimization_runs.py --num_qps=1000 --refl_prob=0.15 --file_path="/work/pi_shertel_umass_edu/quasiparticle_simulation/waveform_comparison/testing/experimental_optimization_runs.pkl" --pos=0.0,0.0,0.05, --setup=3 