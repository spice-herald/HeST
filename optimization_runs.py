...
import HeST as hest
import HeST.optimize_2_1 as o21
import HeST.optimize_2_4 as o24
import HeST.optimize_2_10 as o210
import HeST.optimize_4_1 as o41 
import HeST.optimize_4_4 as o44
import HeST.optimize_4_10 as o410
import HeST.optimize_5_1 as o51
import HeST.optimize_6_1 as o61
import HeST.optimize_6_4 as o64
import HeST.optimize_6_10 as o610

detectors_list = [o21, o24, o210, o41, o44, o410, o51,  o61, o64, o610]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--setup', type=int, default=0, help='Iterator of the optimization detectors. o21 is 0, o610 is 8, steps first in spacing gap, then steps in helium height')
    # parser.add_argument('--save_paths', type=bool, default=False, help = 'Boolean saying whether or not to save the paths with the data. (in order to create an X-Y arrival paths array)')
    args = parser.parse_args()


    diff_prob = 0.8
    refl_prob = 0.2
    evap_eff =[0.0, 0.0, 0.125, 0.0, 0.5, 0.0]
    num_qps = 10000   
    for i in range(9): 
        if i == args.setup:
            detector = detectors_list[i].Amherst_split_cpd
    if args.diff_prob:
